...
def doCopy(summary):
	...
	if pathSrc == "":
		...
		summary2 = summary.get() + "\nRobocopy Info...\n\nSource = "+pathSrc+"\nTarget1 = "+pathDst1+"\nTarget2 = "+pathDst2+"\n"
		summary.set(summary2)
		print (summary2)
		numdest = 0
		...
		if numdest==1:
			if pathDst1 == "":
				pathDst1 = pathDst2
				pathDst2 = ""
		print ("Run until here at least")	
		summary = "Robocopy Info...\n\nSource = "+pathSrc+"\nTarget1 = "+pathDst1+"\nTarget2 = "+pathDst2+"\n"
...
"""
summaryLabel = Label(root, textvariable=summary, font = "arial 10")
summaryLabel.config(bg = "light steel blue", fg="black")
summaryLabel.pack(padx = 15, pady = 10, anchor="w")
"""
spaceLabel = Label(root, text=" ", font = "arial 10")
spaceLabel.config(bg = "light steel blue", fg="black")
spaceLabel.pack(padx = 15, anchor="w")

doCopyButton = Button(root, text = 'Do Copy !', width = 8, overrelief=RIDGE, font = "arial 10", command = doCopy(summary))
